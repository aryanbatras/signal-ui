...
export function Button(contract = {}) {
  ...
  // Focus animations
  signals.focusRing && focus("focus:ring-2 focus:ring-offset-2 focus:ring-blue-500", "focusRing").transitionAll;
  signals.focusScale && focus("focus:scale-105 transition-transform", "focusScale").transitionAll;
  signals.focusGlow && focus("focus:shadow-outline focus:shadow-blue-500/30", "focusGlow").transitionAll;
